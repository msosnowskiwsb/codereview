    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "codereview");
                servletContext.setInitParameter("tapestry.development-modules", "codereview.services.DevelopmentModule");
